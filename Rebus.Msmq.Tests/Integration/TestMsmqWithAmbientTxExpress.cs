...
namespace Rebus.Msmq.Tests.Integration
{
    ...
    public class TestMsmqWithAmbientTxExpress : FixtureBase
    {
        ...
        protected override void SetUp()
        {
            ...
            _bus = Configure.With(_activator)
                ...
                .Transport(t => t.UseMsmqWithAmbientTransactionSupport(queueName))
                .Options(o =>
                {
        ...
        public async Task TestPerformance(int messageCount, bool express)
        {
            ...
            {
                Console.WriteLine($"Sleeping on thread #{Thread.CurrentThread.ManagedThreadId} for 1000ms");
                Thread.Sleep(1000);
